...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <a href="javascript:;">{{\Illuminate\Support\Facades\Auth::guard('admin')->user()->username}}</a>
            <dl class="layui-nav-child">
                <!-- 二级菜单 -->
                <dd>
                    <a onclick="xadmin.open('修改密码','/admin/account/edit')">修改密码</a></dd>
                <dd>
                    <a onclick="xadmin.open('切换帐号','/admin/login')">切换帐号</a></dd>
                <dd>
        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('修改密码','/admin/account/edit')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>修改密码</cite></a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('标签列表','/admin/tags/index')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>标签列表</cite></a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('视频列表','/admin/videos')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>视频列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('新增视频','/admin/videos/create')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>新增视频</cite></a>
                    </li>
                </ul>
